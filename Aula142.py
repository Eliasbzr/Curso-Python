...
class Log(ABC): 
    @abstractmethod #tornando a classe abstrata, ou seja ela n pode ser utilizada diretamente
    def _log(self, msg): ... #para tornar em classe abstata e tirar o corpo da funcao
...
class LogPrintMixin(Log): #usando a classe abstrata por herarnca => 
    def _log(self, msg):
